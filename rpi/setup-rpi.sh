...
sudo ln -sv ~/dotfiles/rpi/dhcpcd.conf /etc/ssh/dhcpcd.conf
...
mkdir -p /mnt/usb0/minidlna/{music,pictures,videos}
...
sudo ln -sv /etc/transmission-daemon/settings.json ${HOME}/.config/transmission-daemon/
